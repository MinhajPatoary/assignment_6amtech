import 'package:assignment_6amtech/data/new_on_app_name_model.dart';
...
class NewOnAppNameView extends StatelessWidget {
  const NewOnAppNameView({Key? key}) : super(key: key);
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemCount: newOnAppNameList.length,
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: NetworkImage(
                                        newOnAppNameList[index].storeImage),
                                  ),
                                ),
                              ),
                              // const SizedBox(height: 10),
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        newOnAppNameList[index].storeName,
                                        style: textStyle.copyWith(
                                          fontSize: 12,
                                        ),
                                      ),
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          text:
                                              newOnAppNameList[index].areaName,
                                      ...
                                      Row(
                                        children: [
                                          RatingBar(
                                            ratingValue:
                                                newOnAppNameList[index].rating,
                                            color: primarySwatch,
                                            size: 10,
                                          ),
                                          const SizedBox(width: 5),
                                          Text(
                                            "(${newOnAppNameList[index].cutomer.toString()})",
                                            style: hintTextStyle.copyWith(
                                              fontSize: 10,
                                            ),
                                          ),
                          ...
                          newOnAppNameList[index].freeDelivery == null ||
                                  newOnAppNameList[index].freeDelivery != true
                              ? const SizedBox()
                              : Positioned(
                                  top: 25,
                                  // left: 0,
